...
if __name__ == "__main__":
    ...
    ocr_processor = DBSBankStatementOCR(pdf_path=pdf_file, file_name=pdf_filename)
    ...
    regex_patterns = {
        ...
        "start_marker": "DBS Multiplier Account Account",
        "end_marker": "Transaction Details as of"
    }
